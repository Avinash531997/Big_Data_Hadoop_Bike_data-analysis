...
public class Top5Popular{
	public static class TMapper extends Mapper<Object, Text, Text, IntWritable>
	{
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			END_STATION.set(splits[8]);
			}
			String keys = STATION.toString()+ "	"+END_STATION.toString();
	...
	public static void main(String[] args) throws Exception 
	{
		...
		Job job = Job.getInstance(conf, "Top5Popular");
		job.setJarByClass(Top5Popular.class);
